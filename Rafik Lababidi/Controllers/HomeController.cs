...
using Nouraldin_Abdallah.Models;
using System.Data.SqlClient;

namespace Nouraldin_Abdallah.Controllers
{
    public class HomeController : Controller
    {
        private readonly DbConnection dbConnection = new DbConnection();
        SqlConnection con = new SqlConnection("Server = .; DataBase = NouraldinAbdallah; Integrated Security = True");
